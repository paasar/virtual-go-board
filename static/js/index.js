...
(function(exports) {
  ...
  var genericCellState = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Cell line 16, column 8 - line 16, column 56: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var showCellState = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericCellState)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Empty";
  ...
  var eqCellState = new Data_Eq.Eq(Data_Generic_Rep_Eq.genericEq(genericCellState)(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments)))));
  var nextState = function (v) {
      return function (v1) {
          if (v1 instanceof Empty) {
              return Empty.value;
          };
          var $18 = Data_Eq.eq(eqCellState)(v)(v1);
          if ($18) {
              return Empty.value;
          };
          return v1;
  ...
  var cell = function (orientationClass) {
      var render = function (orientationClassName) {
          return function (state) {
              var piece = (function () {
                  var $19 = Data_Eq.eq(eqCellState)(state.current)(Empty.value);
                  if ($19) {
                      return [  ];
                  };
                  return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "piece", Halogen_HTML_Core.ClassName(Data_Show.show(showCellState)(state.current)) ]) ])([  ]) ];
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "cell", orientationClassName ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Toggle.create)) ])(piece);
          };
      };
      var initialState = {
          current: Empty.value,
      ...
      var $$eval = function (v) {
          if (v instanceof HandleInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(eqCellState)(v1.desired)(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $22 = {};
                      for (var $23 in v2) {
          ...
          if (v instanceof Toggle) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var nxtState = nextState(v1.current)(v1.desired);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(eqCellState)(nxtState)(v1.current))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $28 = {};
                      for (var $29 in v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Toggled(v2.current)))(function () {
          ...
          throw new Error("Failed pattern match at Cell line 68, column 10 - line 80, column 12: " + [ v.constructor.name ]);
      };
  ...
  exports["cell"] = cell;
  exports["genericCellState"] = genericCellState;
  exports["showCellState"] = showCellState;
  exports["eqCellState"] = eqCellState;
})(PS["Cell"] = PS["Cell"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var SetMode = (function () {
      function SetMode(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      SetMode.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new SetMode(value0, value1, value2);
              };
          };
      };
      return SetMode;
  ...
  var genericMode = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at ModeSelector line 17, column 8 - line 17, column 46: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Static.value;
      };
  ...
  var eqMode = new Data_Eq.Eq(Data_Generic_Rep_Eq.genericEq(genericMode)(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))));
  var modeSelector = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "mode-selector", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(state.nextPiece)), Halogen_HTML_Core.ClassName(Data_Show.show(showMode)(state.mode)) ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "mode", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(Cell.Black.value)) ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetMode.create(Static.value)(Cell.Black.value))) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "piece", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(Cell.Black.value)) ]) ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "mode", "Alternate" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetMode.create(Alternate.value)(state.nextPiece))) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "piece", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(Cell.Black.value)) ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "piece", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(Cell.White.value)) ]) ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "mode", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(Cell.White.value)) ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetMode.create(Static.value)(Cell.White.value))) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "piece", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(Cell.White.value)) ]) ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "mode", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(Cell.Empty.value)) ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetMode.create(Static.value)(Cell.Empty.value))) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("remove") ])([ Halogen_HTML_Core.text("X") ]) ]) ]);
      };
      var initialState = {
          nextPiece: Cell.Black.value,
          mode: Alternate.value
      };
      var $$eval = function (v) {
          if (v instanceof HandleInput) {
          ...
          if (v instanceof SetMode) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(eqMode)(v.value0)(v1.mode))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $20 = {};
                      for (var $21 in v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Cell.eqCellState)(v.value1)(v1.nextPiece))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $23 = {};
                          for (var $24 in v2) {
                          ...
                          $23.nextPiece = v.value1;
                          return $23;
                      })))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.eq(eqMode)(v.value0)(Alternate.value) && Data_Eq.eq(eqMode)(v1.mode)(Alternate.value))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $27 = {};
                              for (var $28 in v2) {
                              ...
                              $27.nextPiece = (function () {
                                  var $26 = Data_Eq.eq(Cell.eqCellState)(v.value1)(Cell.Black.value);
                                  if ($26) {
                                      return Cell.White.value;
                                  };
                                  return Cell.Black.value;
                              })();
                              return $27;
                          })))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.eq(eqMode)(v.value0)(Alternate.value) && Data_Eq.eq(Cell.eqCellState)(v.value1)(Cell.Empty.value))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  var $30 = {};
                                  for (var $31 in v2) {
                                  ...
                                  $30.nextPiece = Cell.Black.value;
                                  return $30;
                              })))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Changed(v2)))(function () {
          ...
          throw new Error("Failed pattern match at ModeSelector line 82, column 12 - line 98, column 14: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](initialState),
          render: render,
...
})(PS["ModeSelector"] = PS["ModeSelector"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Cell = PS["Cell"];
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var ModeSelector = PS["ModeSelector"];
  var Prelude = PS["Prelude"];                 
  var CellSlot = (function () {
      function CellSlot(value0) {
          this.value0 = value0;
      };
      CellSlot.create = function (value0) {
          return new CellSlot(value0);
      };
      return CellSlot;
  })();
  var CellClicked = (function () {
      function CellClicked(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CellClicked.create = function (value0) {
          return function (value1) {
              return new CellClicked(value0, value1);
          };
      };
      return CellClicked;
  })();
  ...
  var eqCellSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.value0 === y.value0;
      };
  });
  var ordCellSlot = new Data_Ord.Ord(function () {
      return eqCellSlot;
  }, function (x) {
      return function (y) {
  ...
  var createSlot = function (state) {
      return function (cell) {
          return function (slotNumber) {
              return Halogen_HTML.slot(new CellSlot(slotNumber))(cell)(state.action)(Halogen_HTML_Events.input(CellClicked.create));
          };
      };
  };
  var createCells = function (state) {
      return function (cellsPerRow) {
          var middleCellsAmount = cellsPerRow - 2 | 0;
          var middleRow = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Cell.cell("w") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(middleCellsAmount)(Cell.cell("m")))([ Cell.cell("e") ]));
          var middleRows = Data_Array.concat(Data_Array.replicate(middleCellsAmount)(middleRow));
          var topRow = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Cell.cell("nw") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(middleCellsAmount)(Cell.cell("n")))([ Cell.cell("ne") ]));
          var createSlots = function (cells) {
              return Data_Array.zipWith(createSlot(state))(cells)(Data_Array.range(1)(Data_Array.length(cells)));
          };
          var bottomRow = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Cell.cell("sw") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(middleCellsAmount)(Cell.cell("s")))([ Cell.cell("se") ]));
          return createSlots(Data_Semigroup.append(Data_Semigroup.semigroupArray)(topRow)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(middleRows)(bottomRow)));
      };
  };
  var board = function (size) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "board", Halogen_HTML_Core.ClassName("x" + Data_Show.show(Data_Show.showInt)(size)) ]) ])(createCells(state)(size));
      };
      var initialState = {
          action: Cell.Black.value,
          mode: ModeSelector.Static.value
      };
      var $$eval = function (v) {
          ...
          if (v instanceof HandleInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      return "mode";
                  }))(ModeSelector.eqMode))()(new Data_Symbol.IsSymbol(function () {
                      return "action";
                  }))(Cell.eqCellState)))(v.value0)(v1))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          throw new Error("Failed pattern match at Board line 52, column 12 - line 59, column 18: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(ordCellSlot)({
          initialState: Data_Function["const"](initialState),
          render: render,
          "eval": $$eval,
          receiver: Halogen_HTML_Events.input(HandleInput.create)
  ...
  exports["HandleInput"] = HandleInput;
  exports["CellSlot"] = CellSlot;
  exports["board"] = board;
  exports["createCells"] = createCells;
  exports["createSlot"] = createSlot;
  exports["eqCellSlot"] = eqCellSlot;
  exports["ordCellSlot"] = ordCellSlot;
})(PS["Board"] = PS["Board"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var Increase = (function () {
      function Increase(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Increase.create = function (value0) {
          return function (value1) {
              return new Increase(value0, value1);
          };
      };
      return Increase;
  })();
  var Decrease = (function () {
      function Decrease(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Decrease.create = function (value0) {
          return function (value1) {
              return new Decrease(value0, value1);
          };
      };
      return Decrease;
  })();
  var createCaptureZone = function (color) {
      return function (captures) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "capture-zone" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "capture-cell", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(color)) ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Increase.create(color))) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "piece", Halogen_HTML_Core.ClassName(Data_Show.show(Cell.showCellState)(color)) ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(captures)) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("free-cell"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Decrease.create(color))) ])([ Halogen_HTML_Core.text("x") ]) ]);
      };
  };
  var captureZones = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("capture-zones") ])([ createCaptureZone(Cell.Black.value)(state.blackCaptures), createCaptureZone(Cell.White.value)(state.whiteCaptures) ]);
      };
      var initialState = {
          blackCaptures: 0,
          whiteCaptures: 0
      ...
      var $$eval = function (v) {
          if (v instanceof Increase) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.eq(Cell.eqCellState)(v.value0)(Cell.Black.value))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $9 = {};
                      for (var $10 in v2) {
                      ...
                      $9.blackCaptures = v1.blackCaptures + 1 | 0;
                      return $9;
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.eq(Cell.eqCellState)(v.value0)(Cell.White.value))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $12 = {};
                          for (var $13 in v2) {
                          ...
                          $12.whiteCaptures = v1.whiteCaptures + 1 | 0;
                          return $12;
                      })))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
          ...
          if (v instanceof Decrease) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var valueCandidate = (function () {
                      var $18 = Data_Eq.eq(Cell.eqCellState)(v.value0)(Cell.Black.value);
                      if ($18) {
                          return v1.blackCaptures - 1 | 0;
                      };
                      return v1.whiteCaptures - 1 | 0;
                  })();
                  var newValue = (function () {
                      var $19 = valueCandidate >= 0;
                      if ($19) {
          ...
          throw new Error("Failed pattern match at CaptureZones line 39, column 12 - line 55, column 18: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](initialState),
          render: render,
  ...
  exports["captureZones"] = captureZones;
  exports["createCaptureZone"] = createCaptureZone;
})(PS["CaptureZones"] = PS["CaptureZones"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Error_Class = PS["Control.Monad.Error.Class"];
...
(function(exports) {
    "use strict";
  var Board = PS["Board"];
  var CaptureZones = PS["CaptureZones"];
  var Cell = PS["Cell"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  ...
  var ModeChanged = (function () {
      function ModeChanged(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ModeChanged.create = function (value0) {
          return function (value1) {
              return new ModeChanged(value0, value1);
          };
      };
      return ModeChanged;
  })();
  ...
  var nextAction = function (v) {
      return function (cellState) {
          if (v.mode instanceof ModeSelector.Static) {
              return v.action;
          };
          var $8 = Data_Eq.eq(Cell.eqCellState)(v.action)(Cell.Black.value);
          if ($8) {
              return Cell.White.value;
          };
          return Cell.Black.value;
  ...
  var game = function (size) {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modes-and-captures") ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(ModeSelector.modeSelector)(state.action)(Halogen_HTML_Events.input(ModeChanged.create)), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(CaptureZones.captureZones)(Data_Unit.unit)(Data_Void.absurd) ]), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Board.board(size))(state)(Halogen_HTML_Events.input(CellClicked.create)) ]);
      };
      var initialState = {
          action: Cell.Black.value,
          mode: ModeSelector.Alternate.value
      };
      var $$eval = function (v) {
          if (v instanceof ModeChanged) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                  action: v.value0.value0.nextPiece,
                  mode: v.value0.value0.mode
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof CellClicked) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $16.action = nextAction(v1)(v.value0.value0);
                      return $16;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          if (v instanceof HandleKey) {
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "b") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                          action: Cell.Black.value,
                          mode: ModeSelector.Static.value
                      }))(function () {
          ...
          throw new Error("Failed pattern match at Game line 80, column 12 - line 106, column 18: " + [ v.constructor.name ]);
      };
  ...
  exports["ModeChanged"] = ModeChanged;
  exports["CellClicked"] = CellClicked;
  exports["Init"] = Init;
...
(function(exports) {
  ...
  var Web_HTML_Location = PS["Web.HTML.Location"];
  var Web_HTML_Window = PS["Web.HTML.Window"];                 
  var getParams = function __do() {
      var $5 = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.location)();
      return Data_Functor.map(Effect.functorEffect)(function ($6) {
          return Data_Maybe.fromMaybe("")(Data_String_CodeUnits.stripPrefix("?")($6));
      })(Web_HTML_Location.search($5))();
  };
  var main = function __do() {
      Effect_Console.log("Hello Go player!")();
      var v = getParams();
      var size = (function () {
          if (v === "19") {
              return 19;
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v1) {
          return Halogen_VDom_Driver.runUI(Game.game(size))(Data_Unit.unit)(v1);
      }))();
  };
  exports["main"] = main;
